...
//  Taken from: https://github.com/dillidon/alerts-and-pickers
import Foundation
import UIKit
...
extension UIView {
    ...
    public var viewBorderWidth: CGFloat {
        get {
...
public extension UIView {
    ...
    func topRoundCorners(radius: CGFloat) {
...
extension UIView {
    ...
    func changeSubLayerColor(layerName: String, color: UIColor) {
        for item in self.layer.sublayers ?? [] where item.name == layerName {
            item.backgroundColor = color.cgColor
        }
    }
}

extension UIView {
    func applyBorderAndCornerRadius(_ borderColor: UIColor, borderWidth: CGFloat) {
        roundCorners()
        border(with: borderWidth, borderColor: borderColor.cgColor)
    }
}
